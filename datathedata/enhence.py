...
if __name__ == '__main__':
    ...
    parser.add_argument('--source_img_path', type=str, default='origindata/img')
    parser.add_argument('--source_xml_path', type=str, default='origindata/label')
    parser.add_argument('--save_img_path', type=str, default='enhencedata/Images2')
    parser.add_argument('--save_xml_path', type=str, default='enhencedata/Annotations2')
